...
from app.api.planes import planes
...
app = FastAPI(openapi_url="/api/v1/planes/openapi.json", docs_url="/api/v1/planes/docs")
...
app.include_router(planes, prefix='/api/v1/planes', tags=['planes'])